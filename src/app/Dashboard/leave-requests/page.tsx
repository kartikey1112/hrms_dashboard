        ...
        <table className="w-full text-sm">
          <thead className="bg-muted sticky top-0">
            <tr>
              ...
              <th className="text-left p-3 text-muted-foreground font-medium">Leave Type</th>
              <th className="text-left p-3 text-muted-foreground font-medium">Start Date</th>
              <th className="text-left p-3 text-muted-foreground font-medium">End Date</th>
              <th className="text-left p-3 text-muted-foreground font-medium">Status</th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((leave) => (
              <tr key={leave.id} className="border-t border-theme hover:bg-muted/50 transition-colors">
